...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('gambar_1')

WebUI.click(findTestObject('Object Repository/Page_Applitools/a_diff2'))

WebUI.click(findTestObject('Object Repository/Page_Applitools/button_Click me'))

CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('gambar_2')

WebUI.click(findTestObject('Object Repository/Page_Applitools/img_Click me_diff2'))
