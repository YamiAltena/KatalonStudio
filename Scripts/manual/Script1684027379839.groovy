...
WebUI.click(findTestObject('Page_OrangeHRM/job_title'))

WebUI.click(findTestObject('Page_OrangeHRM/div_QA Engineer'))

WebUI.click(findTestObject('Page_OrangeHRM/sub_unit'))

WebUI.click(findTestObject('Page_OrangeHRM/div_Quality Assurance'))
